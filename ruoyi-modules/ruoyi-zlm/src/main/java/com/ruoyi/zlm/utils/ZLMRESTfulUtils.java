...
public class ZLMRESTfulUtils {
    ...
    public String sendPost(ZlmMediaServer mediaServer, String api, Map<String, Object> param, RequestCallback callback) {
        return sendPost(mediaServer, api, param, callback, null);
    }


    public String sendPost(ZlmMediaServer mediaServer, String api, Map<String, Object> param, RequestCallback callback, Integer readTimeOut) {
    ...
    public void sendGetForImg(ZlmMediaServer mediaServer, String api, Map<String, Object> params, String targetPath, String fileName) {
        String url = String.format("http://%s:%s/index/api/%s", mediaServer.getIp(), mediaServer.getHttpPort(), api);
    ...
    public ZLMResult<?> isMediaOnline(ZlmMediaServer mediaServer, String app, String stream, String schema) {
    ...
    public ZLMResult<JSONArray> getMediaList(ZlmMediaServer mediaServer, String app, String stream, String schema, ResultCallback callback) {
        Map<String, Object> param = new HashMap<>();
        if (app != null) {
            param.put("app", app);
        }
    ...
    public ZLMResult<JSONArray> getMediaList(ZlmMediaServer mediaServer, String app, String stream) {
    ...
    public ZLMResult<?> getRtpInfo(ZlmMediaServer mediaServer, String stream_id) {
        Map<String, Object> param = new HashMap<>();
    ...
    public ZLMResult<FlagData> delFFmpegSource(ZlmMediaServer mediaServer, String key) {
        Map<String, Object> param = new HashMap<>();
        param.put("key", key);
    ...
    public ZLMResult<FlagData> delStreamProxy(ZlmMediaServer mediaServer, String key) {
        Map<String, Object> param = new HashMap<>();
        param.put("key", key);
    ...
    public ZLMResult<?> setServerConfig(ZlmMediaServer mediaServer, Map<String, Object> param) {
    ...
    public ZLMResult<?> openRtpServer(ZlmMediaServer mediaServer, Map<String, Object> param) {
    ...
    public ZLMResult<?> closeRtpServer(ZlmMediaServer mediaServer, Map<String, Object> param) {
    ...
    public ZLMResult<List<RtpServerResult>> listRtpServer(ZlmMediaServer mediaServer) {
    ...
    public ZLMResult<?> startSendRtpPassive(ZlmMediaServer mediaServer, Map<String, Object> param) {
    ...
    public ZLMResult<?> startSendRtpPassive(ZlmMediaServer mediaServer, Map<String, Object> param, ResultCallback callback) {
    ...
    public ZLMResult<?> startSendRtpTalk(ZlmMediaServer mediaServer, Map<String, Object> param, ResultCallback callback) {
    ...
    public ZLMResult<?> restartServer(ZlmMediaServer mediaServer) {
    ...
    public ZLMResult<StreamProxyResult> addStreamProxy(ZlmMediaServer mediaServer, String app, String stream, String url, boolean enable_audio, boolean enable_mp4, String rtp_type, Integer timeOut) {
        Map<String, Object> param = new HashMap<>();
        param.put("vhost", "__defaultVhost__");
        param.put("app", app);
        param.put("stream", stream);
    ...
    public ZLMResult<FlagData> closeStreams(ZlmMediaServer mediaServer, String app, String stream) {
        Map<String, Object> param = new HashMap<>();
        param.put("vhost", "__defaultVhost__");
        param.put("app", app);
        param.put("stream", stream);
    ...
    public ZLMResult<List<SessionData>> getAllSession(ZlmMediaServer mediaServer) {
    ...
    public void kickSessions(ZlmMediaServer mediaServer, String localPortSStr) {
        Map<String, Object> param = new HashMap<>();
        param.put("local_port", localPortSStr);
        sendPost(mediaServer, "kick_sessions", param, null);
    }

    public void getSnap(ZlmMediaServer mediaServer, String streamUrl, int timeout_sec, int expire_sec, String targetPath, String fileName) {
    ...
    public ZLMResult<?> pauseRtpCheck(ZlmMediaServer mediaServer, String streamId) {
    ...
    public ZLMResult<?> resumeRtpCheck(ZlmMediaServer mediaServer, String streamId) {
        Map<String, Object> param = new HashMap<>(1);
        param.put("stream_id", streamId);
    ...
    public ZLMResult<?> connectRtpServer(ZlmMediaServer mediaServer, String dst_url, int dst_port, String stream_id) {
        Map<String, Object> param = new HashMap<>(1);
        param.put("dst_url", dst_url);
    ...
    public ZLMResult<?> updateRtpServerSSRC(ZlmMediaServer mediaServer, String streamId, String ssrc) {
        Map<String, Object> param = new HashMap<>(1);
        param.put("ssrc", ssrc);
        param.put("stream_id", streamId);
    ...
    public ZLMResult<?> deleteRecordDirectory(ZlmMediaServer mediaServer, String app, String stream, String date, String fileName) {
        Map<String, Object> param = new HashMap<>(1);
        param.put("vhost", "__defaultVhost__");
        param.put("app", app);
        param.put("stream", stream);
    ...
    public ZLMResult<?> loadMP4File(ZlmMediaServer mediaServer, String app, String stream, String datePath) {
        Map<String, Object> param = new HashMap<>(1);
        param.put("vhost", "__defaultVhost__");
        param.put("app", app);
        param.put("stream", stream);
    ...
    public ZLMResult<?> setRecordSpeed(ZlmMediaServer mediaServer, String app, String stream, int speed, String schema) {
        Map<String, Object> param = new HashMap<>(1);
        param.put("vhost", "__defaultVhost__");
        param.put("app", app);
        param.put("stream", stream);
    ...
    public ZLMResult<?> seekRecordStamp(ZlmMediaServer mediaServer, String app, String stream, Double stamp, String schema) {
        Map<String, Object> param = new HashMap<>(1);
        param.put("vhost", "__defaultVhost__");
        param.put("app", app);
        param.put("stream", stream);
